...
<div class="zone-bar">
  <svg viewBox="0 0 400 56" width="400" height="56" role="img" aria-label="Context window split into a smart zone (first 120k tokens) and a dumb zone beyond that">
    <rect x="1" y="1" width="398" height="39" rx="4" fill="currentColor" fill-opacity="0.12" stroke="currentColor" stroke-width="1" />
    <line x1="80" y1="1" x2="80" y2="40" stroke="currentColor" stroke-width="1" stroke-dasharray="4 3" />
    <text x="40" y="21" text-anchor="middle" dominant-baseline="middle" fill="currentColor" font-size="15">smart</text>
    <text x="240" y="21" text-anchor="middle" dominant-baseline="middle" fill="currentColor" font-size="15">dumb zone</text>
    <text x="80" y="56" text-anchor="middle" fill="currentColor" opacity="1" font-size="15">120k</text>
  </svg>
</div>
